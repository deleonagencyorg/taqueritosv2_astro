...
async function getStaticPaths() {
  ...
  for (const mod of files) {
    ...
    paths.push({
      ...
      props: { currentLang: locale, challengeId: challenge.id }
    });
  }
  return paths;
}
...
}, "/Volumes/EMMA SSD/Proyectos/taqueritosv2_astro/src/pages/[lang]/retos-torneos/[challengeId].astro", void 0);

const $$file = "/Volumes/EMMA SSD/Proyectos/taqueritosv2_astro/src/pages/[lang]/retos-torneos/[challengeId].astro";
const $$url = "/[lang]/retos-torneos/[challengeId]";
